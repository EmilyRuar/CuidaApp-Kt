...
object RetrofitClient {
    ...
    // Para emulador Android: usar 10.0.2.2 (localhost PC)
    // Para dispositivo físico: usar IP de tu máquina en la misma red
    private const val BASE_URL = "http://10.0.2.2:8080/"

    private var sessionManager: SessionManager? = null

    /**
     * Inicializar el cliente con SessionManager
     * Llamar desde MainActivity antes de usar la API
     */
